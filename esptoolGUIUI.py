...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lineEditCOMPort = QtGui.QLineEdit(self.verticalLayoutWidget)
        self.lineEditCOMPort.setInputMask(_fromUtf8(""))
        self.lineEditCOMPort.setObjectName(_fromUtf8("lineEditCOMPort"))
        self.horizontalLayout_3.addWidget(self.lineEditCOMPort, QtCore.Qt.AlignHCenter)
        self.lineEditMemory = QtGui.QLineEdit(self.verticalLayoutWidget)
        self.lineEditMemory.setInputMask(_fromUtf8(""))
        self.lineEditMemory.setText(_fromUtf8(""))
        self.lineEditMemory.setObjectName(_fromUtf8("lineEditMemory"))
        self.horizontalLayout_3.addWidget(self.lineEditMemory)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lineEditCOMPort.setToolTip(_translate("MainWindow", "Enter COM Port", None))
        self.lineEditCOMPort.setStatusTip(_translate("MainWindow", "Enter COM Port", None))
        self.lineEditCOMPort.setPlaceholderText(_translate("MainWindow", "COM PORT", None))
        self.lineEditMemory.setPlaceholderText(_translate("MainWindow", "Enter FLASH Size", None))
